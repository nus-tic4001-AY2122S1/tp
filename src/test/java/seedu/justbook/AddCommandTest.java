...
class AddCommandTest {
    ...
    public void descriptionTest() {
        ...
        Bookings expected = new Bookings("meet@Sports Hall One lvl 3",
                LocalDateTime.parse("2021-6-7 09:00",pattern), LocalDateTime.parse("2021-6-7 10:30",pattern));
    ...
    public void endTimeTest() {
        List<Bookings> appointments = new ArrayList<>();
        AddCommand add = new AddCommand("meet@Sports Hall One lvl 3",
                "2021-6-7 09:00", "2021-6-7 10:30");
        add.execute(appointments);
        DateTimeFormatter pattern = DateTimeFormatter.ofPattern("uuuu-M-d HH:mm");
        Bookings expected = new Bookings("meet@Sports Hall One lvl 3",
                LocalDateTime.parse("2021-6-7 09:00",pattern), LocalDateTime.parse("2021-6-7 10:30",pattern));
